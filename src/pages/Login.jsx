      ...
      <div className="w-full flex items-center justify-center py-8">
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-6 sm:p-8 md:p-10 lg:p-12 w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl flex flex-col items-center transition-transform duration-200 hover:scale-[1.025] mx-auto">
          ...
          <form className="w-full" onSubmit={handleSubmit} autoComplete="on">
            ...
            <div className="w-full rounded-2xl border border-gray-200/90 bg-gradient-to-b from-slate-50/90 to-white p-1 shadow-inner mb-3">
              <p className="px-3 pt-2 text-center text-[11px] font-semibold uppercase tracking-wider text-gray-400">
                Acesso rápido
              </p>
              <button
                type="button"
                ...
                className="mt-1 w-full rounded-xl bg-white py-3 sm:py-3.5 border border-gray-200 text-gray-800 font-bold shadow-md shadow-gray-200/50 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/10 transition flex items-center justify-center gap-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                ...
                <span className="text-left leading-tight">
                  <span className="block">Continuar com Google</span>
                  <span className="block text-xs font-normal text-gray-500">Será aberta a página segura do Google</span>
                </span>
              </button>
            </div>
          </form>
